    ...
    const fetchCXOTalkData = async (page = 1) => {
        try {
            ...
            const response = await fetch(
                `https://apicxotv.techplusmedia.com/api/news?populate=*&sort=publishedAt:DESC&filters[$or][0][categories].data[name][$eq]=5G&filters[$or][1][subcategories].data[name][$eq]=5G&pagination[page]=1`
            );
