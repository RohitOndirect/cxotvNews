    ...
    const fetchCXOTalkData = async (page = 1) => {
        try {
            ...
            const response = await fetch(
                `https://apicxotv.techplusmedia.com/api/news?populate=*&sort=publishedAt:DESC&filters[$or][0][categories].data[name][$eq]=Healthcare%20IT%20News&filters[$or][1][subcategories].data[name][$eq]=Healthcare%20IT%20News&filters[$or][2][categories].data[name][$eq]=Health%20CxO%20Talk&filters[$or][3][subcategories].data[name][$eq]=Health%20CxO%20Talk&pagination[page]=1`
            );
        ...
        <div className="flex flex-col w-full h-full">
            ...
            <div className="lg:flex gap-10 lg:px-10 px-5 w-full mt-10">
                        ...
                        {cxoTalkData && cxoTalkData.map((item, index) => {
                            ...
                            return (
                                <div key={index} className="mb-5">
                                    <Link href={`/health-cxo-talk/${seoFriendlySlug}`}>
                ...
                <div className="lg:w-[25%] w-full lg:h-[140rem] lg:overflow-y-scroll">
                    <LatestNews categoryName="health-cxo-talk" />
                </div>
            </div>
